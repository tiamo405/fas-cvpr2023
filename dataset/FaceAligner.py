...
class FaceAligner:
	...
	def align(self, image, gray, rect):
		...
		M = cv2.getRotationMatrix2D(eyesCenter, angle = angle, scale= scale)
...
if __name__=="__main__":
    ...
    # using facial landmarks
        ...
        cv2.imwrite('test.jpg', faceAligned)
        break